...
export const SNAPSHOT_BATCH_WINDOW_MS = parseInt(getEnv("SNAPSHOT_BATCH_WINDOW_MS", "5000"));
export const SNAPSHOT_BATCH_MAX_SIZE = parseInt(getEnv("SNAPSHOT_BATCH_MAX_SIZE", "10"));
